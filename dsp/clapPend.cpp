...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		interface->openVerticalBox("clapPend");
		...
		interface->addHorizontalSlider("clapper", &fslider4, 0.5f, 0.0f, 1.0f, 0.0001f);
		...
		interface->addHorizontalSlider("users", &fslider3, 0.5f, 0.0f, 1.0f, 0.0001f);
		interface->closeBox();
	}
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow7 = (1500 * fslider3);
		float 	fSlow8 = (7e+02f + fSlow7);
		float 	fSlow9 = (0.05f + (0.9f * fslider4));
		float 	fSlow10 = (246 * fSlow9);
		float 	fSlow11 = (1.4e+02f + fSlow7);
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp2 = (1 - (0.6f * ((iTemp1 < 1) & 0)));
			...
			iRec5[0] = (1 + (iRec5[1] * iTemp1));
			int iTemp10 = ((iRec5[0] - 1) < fSlow10);
			fRec6[0] = ((0.999f * fRec6[1]) + fConst9);
			float fTemp11 = (fSlow9 + fRec8[1]);
			fRec8[0] = (fTemp11 - floorf(fTemp11));
			float fTemp12 = ftbl0[int((246.0f * (fRec8[0] * iTemp1)))];
			float fTemp13 = (0.001f * (((iTemp10 * fRec6[0]) * iTemp1) * fTemp12));
			fRec0[0] = (0 - ((((fTemp3 * cosf((fConst1 * (fTemp6 + (fSlow8 * fTemp7))))) * fRec0[1]) + (fTemp9 * fRec0[2])) - fTemp13));
			...
			float fTemp21 = (0.001f * (((iTemp10 * fRec11[0]) * iTemp1) * fTemp12));
			fRec9[0] = (0 - ((((fTemp15 * cosf((fConst1 * (fTemp18 + (fSlow8 * fTemp19))))) * fRec9[1]) + (fTemp20 * fRec9[2])) - fTemp21));
			...
			float fTemp29 = (0.001f * (((iTemp10 * fRec14[0]) * iTemp1) * fTemp12));
			fRec12[0] = (0 - ((((fTemp23 * cosf((fConst1 * (fTemp26 + (fSlow8 * fTemp27))))) * fRec12[1]) + (fTemp28 * fRec12[2])) - fTemp29));
			...
			float fTemp37 = (0.001f * (((iTemp10 * fRec17[0]) * iTemp1) * fTemp12));
			fRec15[0] = (0 - ((((fTemp31 * cosf((fConst1 * (fTemp34 + (fSlow8 * fTemp35))))) * fRec15[1]) + (fTemp36 * fRec15[2])) - fTemp37));
			...
			float fTemp39 = (0.001f * ((iTemp10 * iTemp1) * fTemp12));
			float fTemp40 = ((fRec0[0] + (fRec9[0] + (fRec12[0] + (fRec15[0] + fTemp38)))) + (fConst13 * ((fTemp39 - fTemp38) + (fTemp39 - (fRec0[0] + (fRec9[0] + (fRec15[0] + fRec12[0])))))));
			float fTemp41 = (fConst14 + fRec23[1]);
			fRec23[0] = (fTemp41 - floorf(fTemp41));
			float fTemp42 = (0.39269908169872414f * ((1 + max((float)0, min((float)1, fRec2[0]))) + (1 + ftbl1[int((65536.0f * fRec23[0]))])));
			output0[i] = (FAUSTFLOAT)(30 * (fTemp40 * cosf(fTemp42)));
			output1[i] = (FAUSTFLOAT)(30 * (fTemp40 * sinf(fTemp42)));
			// post processing
			fRec23[1] = fRec23[0];
